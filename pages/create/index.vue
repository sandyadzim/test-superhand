    ...
    <div class="card-custom">
      <div class="px-5 pt-5 pb-3">
        <div class="col-md-12 text-center">
          <h2 style="font-family: 'Poppins Bold'">Add Employees</h2>
          <hr style="background-color: #fff" />
        </div>
        <div class="col-md-12">
          <form class="" @submit.prevent="_actionCreate">
  ...
  methods: {
    async _actionCreate() {
      try {
        ...
        const res = await this.$axios.post('karyawan', data, {
    ...
    makeToast() {
      this.$bvToast.toast('Add Employee Success', {
        title: 'Success',
        variant: 'success',
        solid: true,
      })
    ...
    failMakeToast() {
      this.$bvToast.toast('Add Employee Failed', {
        title: 'Failed',
        variant: 'danger',
        solid: true,
      })
